        ...
        <div className='flex flex-row'>
          {
            user.username === "juliusomo" ? <div className='flex flex-row items-center space-x-4'>
              ...
              <button className='flex flex-row  items-center' onClick={() => setEditing(true)}><img src={editIcon} alt="" className='mr-2'/><span className='text-violet-900 font-medium'>Edit</span></button>
              </div> : 
